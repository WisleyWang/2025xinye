...
class ConvFFN(nn.Module):
    ...
    def __init__(self, in_channels, internal_channels, out_channels, drop_path):
        ...
        self.ppw1 = conv_bn(in_channels=in_channels, out_channels=internal_channels, kernel_size=1, stride=1, padding=0, groups=1)
        self.ppw2 = conv_bn(in_channels=internal_channels, out_channels=out_channels, kernel_size=1, stride=1, padding=0, groups=1)
